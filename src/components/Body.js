...
import swiper from "../assets/images/banners/swiper.jpg";
    ...
    <div>
      ...
      <section
        ...
        style={{
          ...
          url(${require("../assets/images/banners/swiper.jpg")})
        `,
      ...
      >
        <div className="grid max-w-screen-xl px-4 py-8 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12  sm:grid-cols-12">
          <div className="lg:col-span-12 md:col-span-6">
            <blockquote class="text-4xl italic font-semibold text-gray-900 dark:text-white">
              <h1 class="text-2xl md:text-3xl lg:text-4xl lg:ml-32 mt-40 mb-32 uppercase">
